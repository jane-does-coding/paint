				...
				<div className="flex w-full h-full z-10 relative">
					<div className="w-9/20">
						...
						<div className="flex flex-col gap-[1vh] mt-[2vh]">
							<p className="finger-paint text-[2.5vh]">
								Experienceable Demo Link
							</p>
							<p className="finger-paint text-[2.5vh]">Public GitHub URL</p>
							<p className="finger-paint text-[2.5vh]">README URL</p>
							<p className="finger-paint text-[2.5vh]">Project Description</p>
							<p className="finger-paint text-[2.5vh]">Project screenshot</p>
						</div>
					</div>
					<div className="w-11/20 pl-[2vw] h-full overflow-y-auto">
